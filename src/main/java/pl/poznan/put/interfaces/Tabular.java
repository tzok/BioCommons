...
public interface Tabular {
  /**
   * Generate tabular data which are formatted for UI, so they might be long, complex and with
   * Unicode characters.
   *
  ...
  /**
   * Generate tabular data to be exported to output file i.e. raw numbers with maximum precision and
   * ASCII only.
   *
   * @return An instance of {@link TableModel} with the data.
   */
