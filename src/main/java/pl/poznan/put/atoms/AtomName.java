...
public enum AtomName {
    ...
    _2SG(AtomType.S, "2SG"), C1p(AtomType.C, "C1'"), C2p(AtomType.C, "C2'"),
    C2(AtomType.C, "C2"), C3p(AtomType.C, "C3'"), C3T(AtomType.C, "C3T"),
    C4p(AtomType.C, "C4'"), C4(AtomType.C, "C4"), C5p(AtomType.C, "C5'"),
    C5(AtomType.C, "C5"), C5M(AtomType.C, "C5M"), C5T(AtomType.C, "C5T"),
    C6(AtomType.C, "C6"), C8(AtomType.C, "C8"), CA(AtomType.C, "CA"),
    CAT(AtomType.C, "CAT"), C(AtomType.C, "C"), CAY(AtomType.C, "CAY"),
    CB(AtomType.C, "CB"), CD1(AtomType.C, "CD1"), CD2(AtomType.C, "CD2"),
    CD(AtomType.C, "CD"), CE1(AtomType.C, "CE1"), CE2(AtomType.C, "CE2"),
    CE3(AtomType.C, "CE3"), CE(AtomType.C, "CE"), CG1(AtomType.C, "CG1"),
    CG2(AtomType.C, "CG2"), CG(AtomType.C, "CG"), CH2(AtomType.C, "CH2"),
    CL(AtomType.C, "CL"), CLP(AtomType.C, "CLP"), CR(AtomType.C, "CR"),
    CRP(AtomType.C, "CRP"), CT(AtomType.C, "CT"), CY(AtomType.C, "CY"),
    CZ2(AtomType.C, "CZ2"), CZ3(AtomType.C, "CZ3"), CZ(AtomType.C, "CZ"),
    H1p(AtomType.H, "H1'"), H1(AtomType.H, "H1"), H21(AtomType.H, "H21"),
    H22(AtomType.H, "H22"), H2pp(AtomType.H, "H2''"), H2p(AtomType.H, "H2'"),
    H2(AtomType.H, "H2"), H3p(AtomType.H, "H3'"), H3(AtomType.H, "H3"),
    H3T1(AtomType.H, "H3T1"), H3T2(AtomType.H, "H3T2"),
    H3T3(AtomType.H, "H3T3"), H3T(AtomType.H, "H3T"), H41(AtomType.H, "H41"),
    H42(AtomType.H, "H42"), H4p(AtomType.H, "H4'"), H51(AtomType.H, "H51"),
    H52(AtomType.H, "H52"), H53p(AtomType.H, "H53'"), H53(AtomType.H, "H53"),
    H5pp(AtomType.H, "H5''"), H5p(AtomType.H, "H5'"), H5(AtomType.H, "H5"),
    H5T1(AtomType.H, "H5T1"), H5T2(AtomType.H, "H5T2"),
    ...
    O1P3(AtomType.O, "O1P3"), O1P(AtomType.O, "O1P"), O2p(AtomType.O, "O2'"),
    O2(AtomType.O, "O2"), O2P3(AtomType.O, "O2P3"), O2P(AtomType.O, "O2P"),
    O3p(AtomType.O, "O3'"), O3P3(AtomType.O, "O3P3"), O3T(AtomType.O, "O3T"),
    O4p(AtomType.O, "O4'"), O4(AtomType.O, "O4"), O5p(AtomType.O, "O5'"),
