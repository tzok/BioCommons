...
public enum ChiRange implements Range {
    ...
    private static final MultiKeyMap<ChiRange, RangeDifference> differenceMap =
            new MultiKeyMap<>();

    static {
        ChiRange.differenceMap
                .put(ChiRange.ANTI, ChiRange.ANTI, RangeDifference.EQUAL);
        ChiRange.differenceMap.put(ChiRange.ANTI, ChiRange.HIGH_ANTI,
                                   RangeDifference.SIMILAR);
        ChiRange.differenceMap
                .put(ChiRange.ANTI, ChiRange.SYN, RangeDifference.OPPOSITE);
        ChiRange.differenceMap.put(ChiRange.HIGH_ANTI, ChiRange.ANTI,
                                   RangeDifference.SIMILAR);
        ChiRange.differenceMap.put(ChiRange.HIGH_ANTI, ChiRange.HIGH_ANTI,
                                   RangeDifference.EQUAL);
        ChiRange.differenceMap.put(ChiRange.HIGH_ANTI, ChiRange.SYN,
                                   RangeDifference.DIFFERENT);
        ChiRange.differenceMap
                .put(ChiRange.SYN, ChiRange.ANTI, RangeDifference.OPPOSITE);
        ChiRange.differenceMap.put(ChiRange.SYN, ChiRange.HIGH_ANTI,
                                   RangeDifference.DIFFERENT);
        ChiRange.differenceMap
                .put(ChiRange.SYN, ChiRange.SYN, RangeDifference.EQUAL);
    }
    ...
    public RangeDifference compare(final Range other) {
        if (!(other instanceof ChiRange)) {
            throw new IllegalArgumentException(
                    "A ChiRange object can be compared only with other " +
                    "ChiRange object");
        }
