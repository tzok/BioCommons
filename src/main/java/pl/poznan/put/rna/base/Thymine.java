...
public class Thymine extends Pyrimidine {
    ...
    private Thymine() {
        super(Arrays.asList(new AtomName[] { AtomName.N1, AtomName.C6, AtomName.H6, AtomName.C2, AtomName.O2, AtomName.N3, AtomName.H3, AtomName.C4, AtomName.O4, AtomName.C5, AtomName.C5M, AtomName.H51, AtomName.H52, AtomName.H53 }), "Thymine", 'T', "T", "THY", "DT");
    }
