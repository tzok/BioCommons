    ...
    private Phosphate() {
        super(RNAResidueComponentType.PHOSPHATE,
              Arrays.asList(AtomName.P, AtomName.O1P, AtomName.O2P,
                            AtomName.O3p, AtomName.O5p),
              Arrays.asList(AtomName.O3P, AtomName.PA, AtomName.O1A,
                            AtomName.O2A, AtomName.O3A, AtomName.PB,
                            AtomName.O1B, AtomName.O2B, AtomName.O3B,
