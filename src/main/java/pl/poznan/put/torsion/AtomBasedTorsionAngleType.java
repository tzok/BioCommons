...
public abstract class AtomBasedTorsionAngleType extends TorsionAngleType {
    ...
    protected AtomBasedTorsionAngleType(final MoleculeType moleculeType,
    ...
    public final String getLongDisplayName() {
        return String.format("%s(%s)%s-%s-%s-%s", displayName, getExportName(),
                             atoms.a, atoms.b, atoms.c, atoms.d);
    }
    ...
    public final TorsionAngleValue calculate(final PdbAtomLine a1,
                                             final PdbAtomLine a2,
                                             final PdbAtomLine a3,
