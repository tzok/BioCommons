...
public final class Colors {
    ...
    public static Color interpolateColor(final double value, final double min,
                                         final double max) {
        double v = value;
        ...
        final double h = (ratio * (Colors.RED_HSB[0] - Colors.GREEN_HSB[0])) +
                         Colors.GREEN_HSB[0];
        final double s = (ratio * (Colors.RED_HSB[1] - Colors.GREEN_HSB[1])) +
                         Colors.GREEN_HSB[1];
        final double b = (ratio * (Colors.RED_HSB[2] - Colors.GREEN_HSB[2])) +
                         Colors.GREEN_HSB[2];
