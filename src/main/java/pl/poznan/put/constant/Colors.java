...
public final class Colors {
     ...
     */
    // @formatter:on
    public static final String[] DISTINCT_COLORS_HEX = new String[] { "#b21800", "#cc7033", "#b8e600", "#3df23d", "#ace6d2", "#80b3ff", "#a280ff", "#661a4d", "#33000e", "#b26559", "#594f43", "#5c6633", "#008c13", "#00c2f2", "#000033", "#7a00e6", "#bf3069", "#4c1400", "#4c3300", "#b6bf8f", "#80ffb2", "#335c66", "#303040", "#ff40f2", "#f20041", "#bf9c8f", "#d9b836", "#17330d", "#165943", "#1d4b73", "#341d73", "#cc99c2", "#66001b" };
    public static final Color[] DISTINCT_COLORS = new Color[Colors.DISTINCT_COLORS_HEX.length];
    ...
    static {
        ...
        for (int i = 0; i < Colors.DISTINCT_COLORS_HEX.length; i++) {
            Colors.DISTINCT_COLORS[i] = Color.decode(Colors.DISTINCT_COLORS_HEX[i]);
        }
    }
