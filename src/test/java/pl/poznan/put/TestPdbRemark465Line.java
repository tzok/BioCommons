...
public class TestPdbRemark465Line {
    private final String validLine = "REMARK 465       C 0   126                                                      ";
    ...
    private final String commentLine1 = "REMARK 465 THE FOLLOWING RESIDUES WERE NOT LOCATED IN THE                       ";
    private final String commentLine2 = "REMARK 465 IDENTIFIER; SSSEQ=SEQUENCE NUMBER; I=INSERTION CODE.)                ";
