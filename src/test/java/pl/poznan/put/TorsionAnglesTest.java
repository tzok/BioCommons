...
public class TorsionAnglesTest {
    ...
    public final void testAngle() throws PdbParsingException {
        ...
        assertEquals(0.0, v1.distance(TorsionAnglesTest.V1),
                     TorsionAnglesTest.EPSILON_E6);
        assertEquals(0.0, v2.distance(TorsionAnglesTest.V2),
                     TorsionAnglesTest.EPSILON_E6);
        assertEquals(0.0, v3.distance(TorsionAnglesTest.V3),
                     TorsionAnglesTest.EPSILON_E6);
        ...
        assertEquals(0.0, tmp1.distance(TorsionAnglesTest.TMP1),
                     TorsionAnglesTest.EPSILON_E6);
        assertEquals(0.0, tmp2.distance(TorsionAnglesTest.TMP2),
                     TorsionAnglesTest.EPSILON_E6);
        assertEquals(0.0, tmp3.distance(TorsionAnglesTest.TMP3),
                     TorsionAnglesTest.EPSILON_E6);

        final double torsionAngleRadians =
                FastMath.atan2(tmp3.dotProduct(tmp2), tmp1.dotProduct(tmp2));
        assertEquals(TorsionAnglesTest.RADIANS, torsionAngleRadians,
                     TorsionAnglesTest.EPSILON_E6);

        final double torsionAngleDegrees = Math.toDegrees(torsionAngleRadians);
        assertEquals(TorsionAnglesTest.DEGREES, torsionAngleDegrees,
                     TorsionAnglesTest.EPSILON_E6);
        ...
        assertEquals(TorsionAnglesTest.RADIANS,
                     ...
                     TorsionAnglesTest.EPSILON_E6);
        assertEquals(TorsionAnglesTest.DEGREES,
