...
public class PdbHeaderLineTest {
    ...
    private static final String TOO_SHORT_LINE = PdbHeaderLineTest.VALID_LINE
            .substring(0, PdbHeaderLineTest.VALID_LINE.length() - 20);
    ...
    public final void testParseToString() throws PdbParsingException {
        final PdbHeaderLine parsed =
                PdbHeaderLine.parse(PdbHeaderLineTest.VALID_LINE);
