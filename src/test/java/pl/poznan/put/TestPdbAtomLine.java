...
public class TestPdbAtomLine {
    private final String validLine =
            "ATOM      1  OP3   G A   1      50.193  51.190  50.534  1.00 "
            + "99.85           O  ";
    ...
    private final String validLineWithOneLetterAtom =
            "ATOM      2  P     G A   1      50.626  49.730  50.573  "
            + "1.00100.19           P  ";
    private final String missingTempFactor =
            "ATOM      1  N   GLU     1      42.189  22.849  47.437  1.00    "
            + "             N  ";
