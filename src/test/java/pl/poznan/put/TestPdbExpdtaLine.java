...
public class TestPdbExpdtaLine {
    private final String validXrayLine = "EXPDTA    X-RAY DIFFRACTION                                                     ";
    private final String validNmrLine = "EXPDTA    SOLUTION NMR                                                          ";
    private final String validThreeMethods = "EXPDTA    SOLID-STATE NMR; SOLUTION SCATTERING; ELECTRON MICROSCOPY             ";
    private final String validWithSpace = "EXPDTA    SOLUTION NMR ; THEORETICAL MODEL                                      ";
    private final String invalidLine = "EXPDTA    SOLUTION XYZ                                                          ";

    @Test
    public void testParseXray() throws PdbParsingException {
        PdbExpdtaLine parsed = parse(validXrayLine);
        List<ExperimentalTechnique> experimentalTechniques = parsed.getExperimentalTechniques();
