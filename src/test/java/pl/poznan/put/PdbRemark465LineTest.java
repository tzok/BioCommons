...
public class PdbRemark465LineTest {
    ...
    private static final String TOO_SHORT_LINE = PdbRemark465LineTest.VALID_LINE
            .substring(0, PdbRemark465LineTest.VALID_LINE.length() - 10);
    ...
    public final void testParseToString() throws PdbParsingException {
        final PdbRemark465Line parsed =
                PdbRemark465Line.parse(PdbRemark465LineTest.VALID_LINE);
        final String parsedToString = parsed.toString();
        assertFalse(PdbRemark465Line
                            .isCommentLine(PdbRemark465LineTest.VALID_LINE));
    ...
    public final void testShortLine() throws PdbParsingException {
        assertFalse(PdbRemark465Line.isCommentLine(
                PdbRemark465LineTest.TOO_SHORT_LINE));
    ...
    public final void testMisalignedLine() throws PdbParsingException {
        assertFalse(PdbRemark465Line.isCommentLine(
                PdbRemark465LineTest.MISALIGNED_LINE));
        PdbRemark465Line.parse(PdbRemark465LineTest.MISALIGNED_LINE);
    }

    @Test
    public final void testCommentLines() {
        assertTrue(PdbRemark465Line
                           .isCommentLine(PdbRemark465LineTest.COMMENT_LINE_1));
        assertTrue(PdbRemark465Line
                           .isCommentLine(PdbRemark465LineTest.COMMENT_LINE_2));
    }
}
